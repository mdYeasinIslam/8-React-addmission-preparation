    ...
    return (
        <div className=' mt-5 '>
            <h3>Answer of some Question......</h3>
                ...
                <div className='mt-3'>
                    <button type="button" class="btn btn-primary mx-auto d-block w-100" data-bs-toggle="modal" data-bs-target="#exampleModal">
                        Question-1
                    </button>
                ...
                <div className='mt-4'>
                    <button type="button" class="btn btn-primary mx-auto d-block w-100" data-bs-toggle="modal" data-bs-target="#exampleModal2">
                        Question-2
                    </button>
                ...
                <div className='mt-4'>
                    <button type="button" class="btn btn-primary mx-auto d-block w-100" data-bs-toggle="modal" data-bs-target="#exampleModal3">
                        Question-3
                    </button>
